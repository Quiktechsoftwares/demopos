                ...
                <div class="content-module-main cf">
                    ...
                    if (isset($_POST['total'])) {
                        ...
                        if ($validated_data === false) {
                            ...
                            $tax_amount = mysqli_real_escape_string($db->connection,$_POST['tax_amount']);
                            if($tax_amount == ""){
                                $tax_amount = 00;
                            }
                            ...
                            for ($i = 0; $i < count($stock_name); $i++) {
                                ...
                                if ($count >= 1) {
                                    ...
                                    if($str == ''){
                                    $db->query("insert into stock_sales (tax,tax_amount,tax_dis,discount,dis_amount,grand_total,transactionid,stock_name,selling_price,quantity,amount,date,username,customer_id,subtotal,payment,mode,description,count1,billnumber)
                            values('$tax','$tax_amount','$tax_dis','$discount','$dis_amount','$payable','$autoid_new','$name1','$rate','$quantity','$total','$mysqldate','$username','$customer','$subtotal','$payment','$mode','$description',$i+1,'$bill_no')");
                                    }
                                     if($str != ''){
                                    $db->query("insert into stock_sales (tax,tax_amount,tax_dis,discount,dis_amount,grand_total,transactionid,stock_name,selling_price,quantity,amount,date,username,customer_id,subtotal,payment,mode,description,count1,billnumber)
                            values('$tax','$tax_amount','$tax_dis','$discount','$dis_amount','$payable','$autoid','$name1','$rate','$quantity','$total','$mysqldate','$username','$customer','$subtotal','$payment','$mode','$description',$i+1,'$bill_no')");
                                     }
                    ...
                    <form name="form1" method="post" id="form1" action="">
                        ...
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td> &nbsp;</td>
                                <td> Tax:
                                    <input type="hidden" name="gst" readonly="readonly" id="tot_gst">
                                    <input type="text" id="tax" name="tax" onkeypress="return numbersonly(event);" onkeyup="addtax();"></td>
