                                ...
                                */
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                   ...
                                   <tr id='tr<?php echo $row['id']; ?>'>
                                        ...
                                        <td><?php echo $row['l_va']; ?></td>
                                        <td><?php echo $row['lr_sph']; ?></td>
                                        <td><?php echo $row['lr_cyl']; ?></td>
                                        <td><?php echo $row['lr_axis']; ?></td>
                                        <td><?php echo $row['lr_va']; ?></td>
                                        <td></td>
                                        <td><?php echo $row['r_sph']; ?></td>
                                        <td><?php echo $row['r_cyl']; ?></td>
                                        <td><?php echo $row['r_axis']; ?></td>
                                        <td><?php echo $row['r_va']; ?></td>                                        
                                        <td><?php echo $row['rr_sph']; ?></td>
                                        <td><?php echo $row['rr_cyl']; ?></td>
                                        <td><?php echo $row['rr_axis']; ?></td>
                                        <td><?php echo $row['rr_va']; ?></td>
                                        <td><?php echo $row['lense_type']; ?></td>
