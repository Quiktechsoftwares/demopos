...
function addtax()
{
    ...
    var gtot= parseFloat(document.getElementById('grand_total').value);
    var am = parseFloat(gtot/100);
    var tax = parseFloat(document.getElementById('tax').value);
    var gst = parseFloat(am*tax);    
    parseFloat(document.getElementById('tot_gst').value = gst);
    // alert('GST is '+ gst);

    if (parseFloat(document.getElementById('tot_gst').value) > parseFloat(document.getElementById('grand_total').value))
        document.getElementById('tot_gst').value = "";
    var result = isNaN(parseFloat(document.getElementById('tot_gst').value));
    ...
    if (document.getElementById('grand_total').value != "") {
        if (parseFloat(document.getElementById('tax').value) < parseFloat(document.getElementById('grand_total').value)) {
            tax = parseFloat(document.getElementById('tot_gst').value);
            document.getElementById('payable_amount').value = parseFloat(document.getElementById('grand_total').value) - discont + tax;
            document.getElementById('tax_amount').value = gst;
            if (parseFloat(document.getElementById('grand_total').value) > parseFloat(document.getElementById('payable_amount').value)) {
                // document.getElementById('payment').value = parseFloat(document.getElementById('payable_amount').value);
            }
        }        
