...
INSERT INTO `customer_details` (`id`,`date_of_birth`, `customer_name`, `customer_address`, `customer_contact1`, `customer_contact2`,`l_sph`,`l_cyl`,`l_axis`,`l_va`,`r_sph`,`r_cyl`,`r_axis`,`r_va` `balance`) VALUES
  (1,1-1-1999,'chandru','123','1234567890','1234567890',1,2,1,2,3,4,3,4);
