...
$count=0;
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    <tr id='tr<?php echo $row['id']; ?>'>
                                        ...
                                        <!-- <td><a href="print_invoice.php" target="_blank" id="print" name="print"><strong style="font-size: 17px; background-color: #20639b; color: white; padding: 5px; margin: 5px;">Print</strong></a></td> -->
                                        <!-- <form action="print_invoice.php" target="_blank" id="form1" name="form1">
